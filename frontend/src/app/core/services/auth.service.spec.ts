...
describe('AuthService', () => {
  ...
  const fakePayload = { user_id: 1, email: 'test@example.com', first_name: 'Test', last_name: 'User', role: 'manager', organization_id: 1, language: 'en' };
  ...
  describe('initialization from localStorage', () => {
    it('should restore user from localStorage on creation', () => {
      const storedUser: UserInfo = { id: 5, email: 'stored@test.com', first_name: 'S', last_name: 'U', role: 'client', organization_id: 2, language: 'en' };
