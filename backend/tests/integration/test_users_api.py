...
class TestUserList:
    def test_manager_lists_users(self, manager_client, manager):
        EngineerFactory.create_batch(2)
...
class TestUserSoftDelete:
    def test_destroy_deactivates_user(self, manager_client):
        eng = EngineerFactory()
    ...
    def test_deactivated_user_still_in_db(self, manager_client):
        eng = EngineerFactory()
...
class TestUserUpdate:
    def test_manager_updates_user(self, manager_client):
        eng = EngineerFactory()
